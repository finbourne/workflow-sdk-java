...
import com.finbourne.workflow.extensions.auth.HttpFinbourneTokenProvider;
import com.finbourne.workflow.extensions.auth.RefreshingTokenProvider;
import com.finbourne.workflow.extensions.auth.FinbourneToken;
...
public class ApiClientBuilder {
    ...
    * for communicating with lusidWorkflow via the APIs
    *
    ...
    *
    * @param apiConfiguration configuration to connect to lusidWorkflow API
    * @return
    *
