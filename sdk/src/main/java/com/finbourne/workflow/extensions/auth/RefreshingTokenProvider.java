...
* token expiry to ensure continued connectivity to workflow API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with workflow.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to workflow
    */
