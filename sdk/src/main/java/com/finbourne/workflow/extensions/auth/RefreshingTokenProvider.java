...
* token expiry to ensure continued connectivity to lusidWorkflow API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with lusidWorkflow.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to lusidWorkflow
    */
