...
public class UpdateMatchingTasksActivity {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateMatchingTasksActivity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchingTasksActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchingTasksActivity is not found in the empty JSON string", UpdateMatchingTasksActivity.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMatchingTasksActivity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMatchingTasksActivity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMatchingTasksActivity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMatchingTasksActivity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMatchingTasksActivity.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMatchingTasksActivity>() {
           @Override
           public void write(JsonWriter out, UpdateMatchingTasksActivity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMatchingTasksActivity read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateMatchingTasksActivity
  */
  public static UpdateMatchingTasksActivity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMatchingTasksActivity.class);
  }
