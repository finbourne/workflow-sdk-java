...
public class WorkerConfigurationResponse extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<HorizonIntegrationResponse> adapterHorizonIntegrationResponse = gson.getDelegateAdapter(this, TypeToken.get(HorizonIntegrationResponse.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<WorkerConfigurationResponse>() {
                ...
                public void write(JsonWriter out, WorkerConfigurationResponse value) throws IOException {
                    ...
                    // check if the actual instance is of the type `HorizonIntegrationResponse`
                    if (value.getActualInstance() instanceof HorizonIntegrationResponse) {
                      JsonElement element = adapterHorizonIntegrationResponse.toJsonTree((HorizonIntegrationResponse)value.getActualInstance());
                      elementAdapter.write(out, element);
                      return;
                    }
                    // check if the actual instance is of the type `LibraryResponse`
                    if (value.getActualInstance() instanceof LibraryResponse) {
                      JsonElement element = adapterLibraryResponse.toJsonTree((LibraryResponse)value.getActualInstance());
                      elementAdapter.write(out, element);
                      return;
                    }
                    ...
                    // check if the actual instance is of the type `PortfolioHoldingDataQualityCheckResponse`
                    if (value.getActualInstance() instanceof PortfolioHoldingDataQualityCheckResponse) {
                      JsonElement element = adapterPortfolioHoldingDataQualityCheckResponse.toJsonTree((PortfolioHoldingDataQualityCheckResponse)value.getActualInstance());
                      elementAdapter.write(out, element);
                      return;
                    }
                ...
                public WorkerConfigurationResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      HorizonIntegrationResponse.validateJsonElement(jsonElement);
                      actualAdapter = adapterHorizonIntegrationResponse;
                      match++;
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      LibraryResponse.validateJsonElement(jsonElement);
                      actualAdapter = adapterLibraryResponse;
                      match++;
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      PortfolioHoldingDataQualityCheckResponse.validateJsonElement(jsonElement);
                      actualAdapter = adapterPortfolioHoldingDataQualityCheckResponse;
                      match++;
    ...
    public WorkerConfigurationResponse(HorizonIntegrationResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public WorkerConfigurationResponse(LibraryResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public WorkerConfigurationResponse(PortfolioHoldingDataQualityCheckResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    // validate the json string with HorizonIntegrationResponse
    try {
      HorizonIntegrationResponse.validateJsonElement(jsonElement);
      validCount++;
    } catch (Exception e) {
    ...
    // validate the json string with LibraryResponse
    try {
      LibraryResponse.validateJsonElement(jsonElement);
      validCount++;
    } catch (Exception e) {
    ...
    // validate the json string with PortfolioHoldingDataQualityCheckResponse
    try {
      PortfolioHoldingDataQualityCheckResponse.validateJsonElement(jsonElement);
      validCount++;
    } catch (Exception e) {
