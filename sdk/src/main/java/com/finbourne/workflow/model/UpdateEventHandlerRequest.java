...
public class UpdateEventHandlerRequest {
  ...
  **/
  ...
  public UpdateEventHandlerRequest taskActivity(Object taskActivity) {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UpdateEventHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEventHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEventHandlerRequest>() {
           @Override
