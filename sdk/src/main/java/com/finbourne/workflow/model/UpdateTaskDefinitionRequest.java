...
public class UpdateTaskDefinitionRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateTaskDefinitionRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTaskDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTaskDefinitionRequest is not found in the empty JSON string", UpdateTaskDefinitionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateTaskDefinitionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTaskDefinitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTaskDefinitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTaskDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTaskDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTaskDefinitionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateTaskDefinitionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTaskDefinitionRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to UpdateTaskDefinitionRequest
  */
  public static UpdateTaskDefinitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTaskDefinitionRequest.class);
  }
