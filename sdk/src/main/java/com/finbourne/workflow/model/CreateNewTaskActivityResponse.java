...
public class CreateNewTaskActivityResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, initialTrigger, correlationIds, taskFields);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateNewTaskActivityResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNewTaskActivityResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNewTaskActivityResponse is not found in the empty JSON string", CreateNewTaskActivityResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNewTaskActivityResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNewTaskActivityResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNewTaskActivityResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNewTaskActivityResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNewTaskActivityResponse>() {
           @Override
           public void write(JsonWriter out, CreateNewTaskActivityResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNewTaskActivityResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateNewTaskActivityResponse
  */
  public static CreateNewTaskActivityResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNewTaskActivityResponse.class);
  }
