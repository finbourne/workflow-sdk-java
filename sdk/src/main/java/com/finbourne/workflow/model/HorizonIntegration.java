...
public class HorizonIntegration {
  ...
  * @throws IOException if the JSON Element is invalid with respect to HorizonIntegration
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HorizonIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HorizonIntegration is not found in the empty JSON string", HorizonIntegration.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HorizonIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HorizonIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HorizonIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HorizonIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HorizonIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<HorizonIntegration>() {
           @Override
           public void write(JsonWriter out, HorizonIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HorizonIntegration read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to HorizonIntegration
  */
  public static HorizonIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HorizonIntegration.class);
  }
