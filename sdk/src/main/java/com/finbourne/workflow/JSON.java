...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.BatchUpdateTasksRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.BatchUpdateTasksResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.BatchUpsertTaskDefinitionPropertiesResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.BatchUpsertWorkflowPropertiesResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.CalendarContext.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.CalendarReference.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ChangeItem.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ChildTaskDefinitionEdge.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.CorrelationIdMapping.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.CreateLauncherRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.CreateWorkflowRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.CutLabelReference.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DateAdjustment.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DateRegularity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DateTimeAdjustment.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DayOfYear.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DayRegularity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DeleteTasksRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.DeletedEntityResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ErrorDetail.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.EventLauncherDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.EventLauncherDetailsResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.EventMatchingPattern.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.EventTaskFieldMapping.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ExistingTasksNotRecurringConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ExistingTasksRecurringConfiguration.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.GroupReconciliation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.GroupReconciliationResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.HorizonIntegration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.HorizonIntegrationResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.LauncherSchedule.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.LauncherSummaries.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.LibraryResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.LusidEntityDataQualityCheck.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.LusidEntityDataQualityCheckResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.PagedResourceListOfWorkflowResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.RecurrencePattern.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.RelativeMonthRegularity.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ResultsNotRecurringConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ResultsRecurringConfiguration.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ScheduleLauncherDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ScheduleLauncherDetailsResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ScheduleMatchingPattern.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ScheduleMatchingPatternContext.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ScheduleTaskFieldMapping.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.ScheduledTimeAdjustment.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.SpecificMonthRegularity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.SpecifiedTime.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.TimeAdjustment.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.TimeConstraints.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.TimeOfDay.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.TriggerChildTasksAction.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.TriggerChildTasksActionResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.UpdateLauncherRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.UpdateTaskWithIdAndTriggerRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.UpdateWorkerRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.UpdateWorkflowRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.VersionedTaskDefinitionId.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.WeekRegularity.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.WorkflowResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.WorkflowRun.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.WorkflowStructure.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.WorkflowStructureEdges.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.WorkflowStructureNodes.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.finbourne.workflow.model.YearRegularity.CustomTypeAdapterFactory());
